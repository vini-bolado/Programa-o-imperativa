//join junta elementos de uma forma diferente

let produtosCompra = ["carne","legumes","verduras"]

// let separadoPorVirgula = produtosCompra.join("-")

//     console.log(separadoPorVirgula);
